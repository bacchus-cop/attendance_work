export const BRAND_CONFIG = {
  ...
  // โหมดการแสดงผลหลอดเลือด (HP Bar) ใน Mobile Navigation
  // 1 = แสดงหลอดเลือดแบบปกติ (เริ่มต้นหลอดเต็ม 100% เมื่อ HP เต็ม แล้วลดลงเมื่อเสีย HP)
  // 2 = แสดงหลอดเลือดแบบสะสมความเสียหาย (เริ่มต้นหลอด 0% เมื่อ HP เต็ม แล้วเพิ่มขึ้นตามความเสียหายที่ได้รับ)
  hpDisplayMode: 2,
