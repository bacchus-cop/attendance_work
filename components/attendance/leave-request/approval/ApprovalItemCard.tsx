    ...
    return (
        <div className="shrink-0 relative">
            {request.user?.avatarUrl ? (
                ...
                <div className="w-14 h-14 rounded-2xl bg-indigo-50 flex items-center justify-center font-bold text-indigo-400 border-2 border-white shadow-md">
...
export const ApprovalCardDetails: React.FC<ApprovalCardDetailsProps> = ({ 
    request, parsed, cardStyle, annualHolidays, calendarExceptions 
}) => {
    ...
    return (
        <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-x-3 gap-y-2 mb-2">
                ...
                <span className="text-[11px] text-slate-500 font-semibold bg-slate-50/80 px-2 py-0.5 rounded-md border border-slate-100 ml-auto font-mono">
...
export const ApprovalCardActions: React.FC<ApprovalCardActionsProps> = ({
    ...
    return (
        <div className="flex flex-row lg:flex-col gap-2 shrink-0 lg:w-32 lg:justify-center border-t lg:border-t-0 lg:border-l border-black/5 pt-4 lg:pt-0 lg:pl-6 mt-2 lg:mt-0" onClick={(e) => e.stopPropagation()}>
            <button 
                ...
                className="flex-1 px-4 py-3 bg-green-500 hover:bg-green-600 text-white rounded-2xl text-xs font-bold shadow-lg shadow-green-100 transition-all active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
            ...
            <button 
                ...
                className="flex-1 px-4 py-3 bg-white border-2 border-red-100 text-red-500 hover:bg-red-50 rounded-2xl text-xs font-bold transition-all active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
                id={`reject-btn-${request.id}`}
            >
...
ApprovalItemCard.displayName = 'ApprovalItemCard';
